...
class Migration(migrations.Migration):
    dependencies = [
        ("posthog", "1335_taggeditem_project_indexes"),
    ]
    ...
    operations = [
        migrations.RunSQL(
            ...
            """,
            # The reverse restores the replay-scanner-wide constraint that 1334 dropped with a noop
            # reverse. It must build the index itself: this migration unapplies before 1335, so
            # nothing else has.
            reverse_sql="""
