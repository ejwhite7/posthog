...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("posthog", "1334_taggeditem_project"),
    ]

    # `CreateIndexConcurrently` drops any invalid leftover from an interrupted build before
    # retrying, so a transient cancellation can't wedge 1336's ADD CONSTRAINT USING INDEX.
    # Django state for these indexes and constraints was added in 1334.
    operations = [
