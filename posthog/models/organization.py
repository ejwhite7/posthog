...
class OrganizationManager(models.Manager):
    def create(self, *args: Any, **kwargs: Any):
        ...
        # Existing organizations are migrated deliberately; organizations born now start on it.
...
class Organization(ModelActivityMixin, UUIDTModel):
    ...
    uses_most_specific_access_resolution = models.BooleanField(
        ...
        null=True,
        blank=True,
        help_text="When True, access controls resolve with the most specific matching rule. When False, the legacy resolution order applies. New organizations start with True.",
    )
