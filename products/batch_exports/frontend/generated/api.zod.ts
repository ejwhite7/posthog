        ...
        destination: zod
            .object({
                ...
                integration_id: zod
                    ...
                    .nullish()
                    .describe(
                        'ID of a team-scoped Integration providing credentials. Required when creating Databricks, AzureBlob, BigQuery, Postgres, AwsS3, S3Compatible, Snowflake, and Redshift destinations; unused for other types.'
                    ),
            })
            .describe(
